    ...
    <div className={cx("mintNFT-box")}>
      <Row className={cx("first-row")}>
        ...
        <Col span={4}>
          <input
            ...
            onKeyPress={e => e.key === "Enter" && handleChangeTokenId(e)}
          />
          {/* <span>Invalid tokenId</span> */}
          {invalidToken ? <span>Invalid tokenId</span> : <span></span>}
        </Col>
        <Col span={4}>
          {loadingUpdateSupply ? (
        ...
        <Col span={1} style={{ cursor: "pointer" }} onClick={() => setOpenMintNFTBox(null)}>
          <img src={subtractIcon} alt="plus-icon" />
        </Col>
      </Row>
          ...
          <Col span={24} className={cx("one-field", "table-wrapper")} style={{ alignItems: "baseline" }}>
            ...
            <div className={cx("table")}>
              <TableAddAttribute
                ...
                deleteAttribute={() =>
                  setStateForNftData("attributes", listAttribute.slice(0, listAttribute.length - 1))
                }
              />
            </div>
          </Col>
      ...
      <div className={cx("box-bottom")}>
        ...
        <div className={cx("right")}>
          ...
          <Button className={cx("delete")} onClick={() => setListNft(listNft.slice(0, listNft.length - 1))}>
            Delete
          </Button>
        </div>
      </div>
